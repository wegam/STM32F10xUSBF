...
/* Define the STM32F10x hardware depending on the used evaluation board */
  ...
  #define USB_DISCONNECT                      GPIOA  								//WOW
  #define USB_DISCONNECT_PIN                  GPIO_Pin_15						//WOW
  
  #define RCC_APB2Periph_GPIO_DISCONNECT      RCC_APB2Periph_GPIOA	//WOW
  ...
  #define GPIO_Pin_LEFT                       GPIO_Pin_11   /* PE.01 */
  #define GPIO_Pin_RIGHT                      GPIO_Pin_8   /* PE.00 */ 

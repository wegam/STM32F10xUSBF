...
* Description    : 使能或者失能指定的ADC的DMA请求.
...
* Description    : 获取指定的ADC重置校准寄存器的状态.
* Input          : - ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
* Output         : None
...
* Description    : 使能或者失能指定的ADC的软件转换启动功能 .
* Input          : - ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
...
* Description    : 使能或者失能指定的ADC规则组通道的间断模式
* Input          : - ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
...
* Description    : 设置指定ADC的规则组通道，设置它们的转化顺序和采样时间

...
typedef struct
{
  u8 CAN_FilterNumber;									//CAN_FilterNumber指定了待初始化的过滤器，它的范围是1到13。
...
#define CAN_FilterMode_IdList       ((u8)0x01)  /* identifier list mode */	//标识符列表模式
...
/* CAN identifier type */
#define CAN_ID_STD                 ((u32)0x00000000)  /* Standard Id */		//使用标准标识符
#define CAN_ID_EXT                 ((u32)0x00000004)  /* Extended Id */		//使用标准标识符 + 扩展标识符
